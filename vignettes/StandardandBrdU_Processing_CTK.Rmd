...
Build Bowtie2 index of reference genome, mm10 in this vignette. **threads**: number of threads used.
...
### Parsing SAM files
Parsing SAM files toget unique mapped reads and mismatches per read using R-wrapped **parseAlignment.pl** from [CTK](https://zhanglab.c2b2.columbia.edu/index.php/CTK_usage#parseAlignment.pl).
...
Collapse CLIP tags generated by parseAlignment using R-wrapped **tag2collapse.pl** from [CTK](https://zhanglab.c2b2.columbia.edu/index.php/CTK_usage#tag2collapse.pl) of CTK.
